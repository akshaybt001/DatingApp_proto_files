...
var file_user_proto_depIdxs = []int32{
	...
	1, // 3: user.UserService.UserSignup:output_type -> user.UserSignupResponse
	1, // 4: user.UserService.UserLogin:output_type -> user.UserSignupResponse
	1, // 5: user.UserService.AdminLogin:output_type -> user.UserSignupResponse
